...
slider.on "change:value", ->
	...
	plot.midY = Utils.modulate(@value,[slider.min,slider.max],[plotContainer.maxY - plot.height/2, plotContainer.minY + plot.height/2],curve,false)
	
	print plot.scale = Utils.modulate(@value,[slider.min,slider.max],[1,5],curve,false)
